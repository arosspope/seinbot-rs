...
const KRAMER_LINES: [&str; 11779] = [
  ...
  "Yeah.",
  "Oh the red.",
  "Yeah, Its the chicken roaster sign.",
  ...
  "I've been drinking Cafe Latte since the fifth grade and I haven't looked back.",
  ...
  "Jerry I'm so glad we switched apartments.",
  ...
  "All right it's done.",
  "(shaking hands) Yeah.",
  "'Well apparently I do something 'cause I'm sitting at the head table with Mr Mel Torme",
  "Good.",
  ...
  "Uhh.",
  "Oh stop it.",
  "(he slaps Newman's shoulder) What's the matter with you.",
  "(yells) Newmanniun!!",
