...
const ELAINE_LINES: [&str; 13613] = [
  ...
  "Come on.",
  "Move.",
  "(elevator doors reopen; Dr.Burke and two orderlies are revealed) Oh hi Dr. Burke.",
  "I didn't know if uh.... ",
  ...
  "Bye Eeeen.",
  "Let go of my tongue!",
  "Ah, (releases George's ear) whether you're aware of it or not George had this pathetic little plan to, leave something behind so he could weasel a second date.",
  "(uh-oh) Her?",
  ...
  "Shhhhhh.",
  "Here. ",
  "w-w- Well, that's a -ah, it's kind of Sable.",
  ...
  "*Real bad*.",
  "'I'm going to go see Mel Torme with him?'",
  "Ah, this is great.",
  ...
  "Well first we're going to a matinae, I'm taking the afternoon off, we're gonna go see 'My Fair Lady' and they we are gonna go to dinner.",
